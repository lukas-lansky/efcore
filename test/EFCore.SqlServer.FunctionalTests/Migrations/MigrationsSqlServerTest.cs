            ...
            await Test(
                ...
                builder => builder.Entity(
                    "Customer", e =>
                    {
                        ...
                        e.Property<string>("Name");
                        e.Property<DateTime>("SystemTimeStart").HasDefaultValue(DateTime.MinValue).ValueGeneratedOnAddOrUpdate();
                        e.Property<DateTime>("SystemTimeEnd").HasDefaultValue(DateTime.MaxValue).ValueGeneratedOnAddOrUpdate();
                        e.HasKey("Id");
...
EXEC(N'CREATE TABLE [Customer] (
    [Id] int NOT NULL,
    [Name] nvarchar(max) NULL,
    [SystemTimeEnd] datetime2 GENERATED ALWAYS AS ROW END NOT NULL DEFAULT ''9999-12-31T23:59:59.9999999'',
    [SystemTimeStart] datetime2 GENERATED ALWAYS AS ROW START NOT NULL DEFAULT ''0001-01-01T00:00:00.0000000'',
...
EXEC(N'CREATE TABLE [Customer] (
    [Id] int NOT NULL,
    [Name] nvarchar(max) NULL,
    [End] datetime2 GENERATED ALWAYS AS ROW END NOT NULL DEFAULT ''9999-12-31T23:59:59.9999999'',
    [Start] datetime2 GENERATED ALWAYS AS ROW START NOT NULL DEFAULT ''0001-01-01T00:00:00.0000000'',
    CONSTRAINT [PK_Customer] PRIMARY KEY ([Id]),
            ...
            await Test(
                builder => builder.Entity(
                    "Customer", e =>
                    {
                        e.Property<int>("Id").ValueGeneratedOnAdd();
                        e.Property<string>("Name");
                        e.Property<DateTime>("Start").HasDefaultValue(DateTime.MinValue).ValueGeneratedOnAddOrUpdate();
                        e.Property<DateTime>("End").HasDefaultValue(DateTime.MaxValue).ValueGeneratedOnAddOrUpdate();
                        e.HasKey("Id");
            ...
            await Test(
                builder => builder.Entity(
                    "Customer", e =>
                    {
                        e.Property<int>("Id").ValueGeneratedOnAdd();
                        e.Property<string>("Name");
                        e.Property<DateTime>("PeriodStart").HasDefaultValue(DateTime.MinValue).ValueGeneratedOnAddOrUpdate();
                        e.Property<DateTime>("PeriodEnd").HasDefaultValue(DateTime.MaxValue).ValueGeneratedOnAddOrUpdate();
                        e.HasKey("Id");
...
ALTER TABLE [Customer] ALTER COLUMN [PeriodStart] datetime2 NOT NULL;",
                //
                @"DECLARE @var1 sysname;
SELECT @var1 = [d].[name]
FROM [sys].[default_constraints] [d]
...
ALTER TABLE [Customer] ALTER COLUMN [PeriodEnd] datetime2 NOT NULL;");
        }
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Customer]') AND [c].[name] = N'Start');
IF @var0 IS NOT NULL EXEC(N'ALTER TABLE [Customer] DROP CONSTRAINT [' + @var0 + '];');
ALTER TABLE [Customer] ADD DEFAULT '0001-01-01T00:00:00.0000000' FOR [Start];",
                //
                @"DECLARE @var1 sysname;
SELECT @var1 = [d].[name]
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Customer]') AND [c].[name] = N'End');
IF @var1 IS NOT NULL EXEC(N'ALTER TABLE [Customer] DROP CONSTRAINT [' + @var1 + '];');
ALTER TABLE [Customer] ADD DEFAULT '9999-12-31T23:59:59.9999999' FOR [End];",
                //
...
EXEC(N'ALTER TABLE [Customer] SET (SYSTEM_VERSIONING = ON (HISTORY_TABLE = [' + @historyTableSchema + '].[HistoryTable]))')");
            ...
            await Test(
                ...
                builder => builder.Entity(
                    "Customer", e =>
                    {
                        e.Property<int>("Id").ValueGeneratedOnAdd();
                        e.Property<string>("Name");
                        e.Property<DateTime>("ModifiedStart").HasDefaultValue(DateTime.MinValue).ValueGeneratedOnAddOrUpdate();
                        e.Property<DateTime>("ModifiedEnd").HasDefaultValue(DateTime.MaxValue).ValueGeneratedOnAddOrUpdate();
                        e.HasKey("Id");
        ...
        [ConditionalFact]
        public virtual async Task Change_period_default_value_of_temporal_table()
        {
            await Test(
                builder => builder.Entity(
                    "Customer", e =>
                    {
                        ...
                        e.Metadata[SqlServerAnnotationNames.TemporalPeriodStartPropertyName] = "Start";
                        e.Metadata[SqlServerAnnotationNames.TemporalPeriodEndPropertyName] = "End";
                    }),
                builder => builder.Entity(
                    "Customer", e =>
                    {
                ...
                builder => builder.Entity(
                    "Customer", e =>
                    {
                        e.Property<DateTime>("Start").HasDefaultValue(new DateTime(2000, 1, 1)).ValueGeneratedOnAddOrUpdate();
                        e.Property<DateTime>("End").HasDefaultValue(DateTime.MaxValue).ValueGeneratedOnAddOrUpdate();
                    }),
                model =>
                {
...
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Customer]') AND [c].[name] = N'Start');
IF @var0 IS NOT NULL EXEC(N'ALTER TABLE [Customer] DROP CONSTRAINT [' + @var0 + '];');
ALTER TABLE [Customer] ADD DEFAULT '2000-01-01T00:00:00.0000000' FOR [Start];");
        }
